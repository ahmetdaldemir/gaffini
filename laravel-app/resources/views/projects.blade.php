            ...
            <div class="row gy-4">
                <div class="col-xl-6 col-lg-6 col-md-7">
                    <div class="section-title">
                        ...
                        <p class="pt-20">Explore our flooring projects, featuring exceptional craftsmanship, unique designs, and stunning transformations across spaces.</p>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-5 text-md-end">
                    <a href="https://capricorn-theme.com/html/florix/project.html" class="bordered-btn">View All Projects <i class="fa-light fa-arrow-right"></i></a>
                </div>
            </div>
                ...
                <div class="col-lg-4 wow fadeInUp animated" data-wow-delay="200ms">
                    <div class="single-project-item">
                        ...
                        <div class="project-info">
                            ...
                            <a href="project-details.html">Read More</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="project-slider-wrap-two">
        <div class="project-img-slider-two owl-carousel">
            <div class="project-img">
                <img src="assets/img/project-slider/2-1.jpg" alt="">
            </div>
            <div class="project-img">
                <img src="assets/img/project-slider/2-2.jpg" alt="">
            </div>
            <div class="project-img">
                <img src="assets/img/project-slider/2-4.jpg" alt="">
            </div>
        </div>
    </div>
            ...
            <div class="row gy-5">
                <div class="col-xl-5 col-lg-4 col-md-4">
                    <div class="section-title">
                        ...
                        <p class="pt-20">Our seamless flooring process ensures quality from consultation to installation, guaranteeing satisfaction every step of the way.</p>
                    </div>
                    <a href="https://capricorn-theme.com/html/florix/testimonial.html" class="bordered-btn">Get In Touch <i class="fa-light fa-arrow-right"></i></a>
                </div>
                <div class="col-xl-1 col-lg-1 col-md-1"></div>
                <div class="col-xl-6 col-lg-7 col-md-7">
                    <div class="single-process-wrap wow fadeInUp animated" data-wow-delay="200ms">
                        <div class="process-icon">
                            <img src="assets/img/process/2-1.png" alt="">
                    ...
                    <div class="single-process-wrap wow fadeInUp animated" data-wow-delay="400ms">
                        <div class="process-icon">
                            <img src="assets/img/process/2-2.png" alt="">
                    ...
                    <div class="single-process-wrap wow fadeInUp animated" data-wow-delay="600ms mb-0">
                        <div class="process-icon">
                            ...
                            <img src="assets/img/process/2-3.png" alt="">
                        </div>
                        <div class="process-content">
                            <div class="process-title">
                            <h5>Preparation</h5>
